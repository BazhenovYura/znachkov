        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            <div className="reveal opacity-0">
              <span className="inline-block px-4 py-2 border border-gold/30 text-gold text-sm uppercase tracking-widest mb-6">
                Премиум качество
              </span>
            </div>
            ...
            <h1 className="reveal opacity-0 animation-delay-100">
              ...
              <span className="block font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gold-gradient leading-tight mt-2">
                ЗНАЧКИ
              </span>
              <span className="block font-serif text-2xl sm:text-3xl lg:text-4xl text-white/90 mt-4">
                из золота и серебра
              </span>
            </h1>
            ...
            {/* Benefits */}
            <div className="reveal opacity-0 animation-delay-400 grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-gray-800">
          ...
          <div className="reveal opacity-0 animation-delay-300 relative">
            <div className="relative aspect-square lg:aspect-[4/5]">
              ...
              {/* Decorative elements */}
              <div className="absolute -top-4 -right-4 w-24 h-24 border border-gold/30 rounded-lg" />
              <div className="absolute -bottom-4 -left-4 w-32 h-32 border border-gold/20 rounded-lg" />
            </div>
          </div>
        </div>
      </div>
