...
// Иконки через @react-icons/all-files (чистый ESM)
...
export { FaBox as Box } from '@react-icons/all-files/fa/FaBox';
...
export { FaCreditCard as CreditCard } from '@react-icons/all-files/fa/FaCreditCard';
export { FaHammer as Hammer } from '@react-icons/all-files/fa/FaHammer';
export { FaCamera as Camera } from '@react-icons/all-files/fa/FaCamera';
export { FaPalette as Palette } from '@react-icons/all-files/fa/FaPalette';
